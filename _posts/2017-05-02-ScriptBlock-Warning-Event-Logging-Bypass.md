...
**Update: A previous version of this blog post mentioned an issue with scripting this bypass, which has since been solved. The post was updated to include the solution.**
